  ...
  return (
    <NavigationContainer independent={true}>
      <Tab.Navigator initialRouteName="Home" screenOptions={{tabBarHideOnKeyboard:true,headerShown: false,tabBarShowLabel:false,tabBarStyle:{
        height:60,elevation:0,borderTopWidth:2,borderLeftWidth:2,borderRightWidth:2,borderTopLeftRadius:15,borderTopRightRadius:15,borderTopColor:'#00e8ff',borderRightColor:'#00e8ff',borderLeftColor:'#00e8ff',position:'absolute',backgroundColor:bgc
      }}}>
