    ...
    return (
        <KeyboardAvoidingWrapper>
            <View style={{backgroundColor:bgc,height:'100%'}}>
                ...
                <TextInput style={{height:55,width:'80%',marginTop:30,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='name...' onChangeText={(text) => setName(text)} maxLength={13} placeholderTextColor='#a6a4a3'/>
                <TextInput style={{height:55,width:'80%',marginTop:5,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='bio...' onChangeText={(text) => setBio(text)} maxLength={27} placeholderTextColor='#a6a4a3'/>
                <TextInput style={{height:55,width:'80%',marginTop:5,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='email...' onChangeText={(text) => setEmail(text)} placeholderTextColor='#a6a4a3'/>
                <TextInput style={{height:55,width:'80%',marginTop:5,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='username...' onChangeText={(text) => setUid(text)} maxLength={11} placeholderTextColor='#a6a4a3'/>
                <TextInput secureTextEntry={true} style={{height:55,width:'80%',marginTop:5,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='password...' onChangeText={(text) => setPwd(text)} placeholderTextColor='#a6a4a3'/>
                <TextInput secureTextEntry={true} style={{height:55,width:'80%',marginTop:5,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='confirm password...' onChangeText={(text) => setCPwd(text)} placeholderTextColor='#a6a4a3'/>
