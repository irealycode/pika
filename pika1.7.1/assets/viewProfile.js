    ...
    <SafeAreaView style={{backgroundColor:bgc}}>
          <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={['#00e8ff']} progressBackgroundColor={bgc}/>}>
              <View style={{marginBottom:15}}>
                  ...
                  <TouchableOpacity style={{alignSelf:'center',height:30,width:'80%',backgroundColor:'#00e8ff',borderRadius:6,marginTop:15}} onPress={() => FollowUser()}>
                                              ...
                                              <View key={index}>
                                                    <View style={{backgroundColor:'#00e8ff',paddingTop:5,borderRadius:15,paddingBottom:7}}>
                                                        <View style={{left:15,flexDirection:'row'}}>
                                                            ...
                                                            <Text style={{marginLeft:7,fontFamily:'cour',fontSize:16,color:bgc,alignSelf:'center'}} >@{UserData[3]}</Text>
                                                            {isVerified?<Image source={require('./imgs/verified.png')} style={{marginLeft:5,marginBottom:3,alignSelf:'center',height:12,width:12,tintColor:bgc}} />:<View></View>}
                                                        </View>
                                                    ...
                                                    <View style={{height:7,width:10,alignSelf:'center',backgroundColor:'#00e8ff'}}></View>
                                              </View>
