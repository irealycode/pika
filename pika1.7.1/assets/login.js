...
export default function login_suck({navigation}) {
    ...
    return (
        ...
        <View style={{backgroundColor:bgc,height:'100%'}}>
            ...
            <TextInput style={{height:55,width:'80%',marginTop:80,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='username...' onChangeText={(text) => setUid(text)} placeholderTextColor='#a6a4a3' autoCapitalize='none' />
            <TextInput secureTextEntry={true} style={{height:55,width:'80%',marginTop:10,borderWidth:2,borderColor:'#00e8ff',alignSelf:'center',borderRadius:30,paddingHorizontal:20,fontSize:16,fontFamily:'cour',color:'#00e8ff'}} placeholder='password...' onChangeText={(text) => setPwd(text)} placeholderTextColor='#a6a4a3' />
            ...
            <FancyAlert style={{backgroundColor:'#00e8ff'}} visible={visible} icon={<View style={{backgroundColor:bgc,flex: 1,borderRadius: 50,width: '100%',display: 'flex',justifyContent: 'center',alignItems: 'center',}}><Image source={require('./imgs/no.png')} style={{height:23,width:23,tintColor:'#00e8ff'}} /></View>}>
