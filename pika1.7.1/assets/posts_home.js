...
function home_s({navigation}){
  ...
  const onAStart = async() => {
    ...
    console.log('verified:',verifiedd)
    const snapshot = await postsRef.get();
    snapshot.forEach(async (doc) => {
    OnePost = [];
    OnePost.push(doc.data().owner)
  ...
  return (
    <NavigationContainer independent={true}>
      <Stack.Navigator initialRouteName="home"  >
        ...
        <Stack.Screen name="comm" component={suckComm} options={({route}) => ({headerTintColor:fgc,title:'comments',headerTitleStyle:{color:fgc,fontFamily:'cour'},headerStyle:{backgroundColor:bgc}})}/>
