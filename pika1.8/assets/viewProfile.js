  ...
  return (
    ...
    <SafeAreaView style={{backgroundColor:bgc}}>
          <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[lol]} progressBackgroundColor={bgc}/>}>
              ...
              {!isPost?                  <View style={{backgroundColor:lol,paddingTop:0,borderRadius:15,marginBottom:60}}>
              {!userImgs[0] ? <View style={{width:Wwidth,paddingVertical:20,backgroundColor:lol,borderRadius:30}} ><Text style={{textAlign:'center',fontFamily:'cour',fontSize:16,color:bgc}}>{UserData[0]} doesn't have any pics</Text></View>:<View style={{backgroundColor:lol,paddingTop:35,borderRadius:30}}></View>}
              {
                                              ...
                                              <View key={index}>
                                                    <View style={{backgroundColor:lol,paddingTop:5,borderRadius:15,paddingBottom:7}}>
                                                        <View style={{left:15,flexDirection:'row'}}>
                                                            ...
                                                            <Text style={{marginLeft:7,fontFamily:'courierBold',fontSize:16,color:bgc,alignSelf:'center'}} >@{UserData[3]}</Text>
