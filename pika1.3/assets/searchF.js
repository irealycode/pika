                        ...
                        AllUsers.map((image,index)=>{
                            ...
                            return (
                                <View key={index} style={{height:110,width:'85%',alignSelf:'center',marginBottom:10,backgroundColor:'#00e8ff',borderRadius:30}}>
                                    <Image style={{position:'absolute',top:15,left:20,height:80,width:80,borderRadius:150,borderWidth:2,borderColor:'#ffffff'}} source={{uri:'https://firebasestorage.googleapis.com/v0/b/pika-4f9d6.appspot.com/o/'+AllUsers[index][5]+'?alt=media&token=63a74aae-9e63-4382-a1fa-9179491c5f16'}} />
  ...
  return (
    <NavigationContainer independent={true}>
      <Stack.Navigator initialRouteName="search" screenOptions={{headerShown: false}} >
        <Stack.Screen name="search" component={suck_seach} />
