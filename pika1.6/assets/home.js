    ...
    <NavigationContainer independent={true}>
      <Tab.Navigator initialRouteName="Home" screenOptions={{tabBarHideOnKeyboard:true,headerShown: false,tabBarShowLabel:false,tabBarStyle:{
        ...
        <Tab.Screen name="post" component={suck_post} options={{
          tabBarIcon: ({focused}) => (
            <View style={{backgroundColor:focused ? '#00e8ff': bgc,height:30,width:60,borderRadius:10,borderWidth:2,borderColor:focused ? bgc: '#b2b2b2'}}>
              <Text style={{color:focused ? bgc: '#b2b2b2',fontFamily:'cour',fontSize:23,textAlign:'center',position:'absolute',alignSelf:'center',top:-7,}}>+</Text>
            </View>
