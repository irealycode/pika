    ...
    <SafeAreaView style={{backgroundColor:bgc}}>
          <ScrollView showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={['#00e8ff']} progressBackgroundColor={bgc}/>}>
              <View style={{height:290}}>
                  ...
                  <Text style={{position:'absolute',color:'#00e8ff',fontSize:18,fontFamily:'cour',top:60,left:140}} >@{userN}</Text>
              ...
              {!isPost?                  <View style={{backgroundColor:'#00e8ff',paddingTop:0,borderRadius:15,marginBottom:60,paddingBottom:20}}>
              {!userImgs[0] ? <View style={{width:Wwidth,paddingVertical:20,backgroundColor:'#00e8ff',borderRadius:30}} ><Text style={{textAlign:'center',fontFamily:'cour',fontSize:16,color:bgc}}>{UserData[0]} doesn't have any pics</Text></View>:<View style={{backgroundColor:'#00e8ff',paddingTop:35,borderRadius:30}}></View>}
              {
                  ...
                  {!UserPOSTSS[0] ? <View style={{width:Wwidth,paddingVertical:20,backgroundColor:'#00e8ff',borderRadius:30}} ><Text style={{textAlign:'center',fontFamily:'cour',fontSize:16,color:bgc}}>{UserData[0]} doesn't have any posts</Text></View>:<View></View>}
                                    {
                                            ...
                                            return(
                                              <View key={index}>
                                                    <View style={{backgroundColor:'#00e8ff',paddingTop:5,borderRadius:15,paddingBottom:7}}>
                                                        <View>
                                                              <Text style={{fontFamily:'cour',fontSize:16,color:bgc,position:'absolute',top:10,left:60}} >@{userN}</Text>
                                                        ...
                                                        <TouchableWithoutFeedback >
                                                            <View>
                                                              <Image style={{alignSelf:'center',height:Wwidth,width:Wwidth,borderRadius:15,borderWidth:2,borderColor:bgc}} source={{uri:'https://firebasestorage.googleapis.com/v0/b/pika-4f9d6.appspot.com/o/'+index[1]+'?alt=media&token=63a74aae-9e63-4382-a1fa-9179491c5f16'}} />
                                                            </View>
                                                        </TouchableWithoutFeedback>
                                                        <View style={{flexDirection:'row',flex:1}}>
                                                        <Text style={{fontFamily:'cour',fontSize:16,color:bgc,marginLeft:17,marginRight:40}} >{index[0]}</Text>
                                                        <TouchableOpacity style={{position:'absolute',right:10,bottom:-3,flex:1,flexDirection:'row'}}>
                                                              <Image style={{opacity:1,height:32,width:32,tintColor:bgc,position:'absolute',right:13,top:5}} source={require('./imgs/like.png')} />
                                                              {!index[2]?<Text style={{marginTop:7,color:bgc,fontFamily:'cour',fontSize:16}} >0</Text>:<Text style={{marginTop:7,color:bgc,fontFamily:'cour',fontSize:16}} >{index[2].length}</Text>}
                                                        </TouchableOpacity>
                                                    </View>
