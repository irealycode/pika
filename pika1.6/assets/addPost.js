...
export default function suck_post() {
  ...
  return (
      ...
      <View style={{backgroundColor:bgc,paddingBottom:100}} >
          ...
          <TouchableOpacity style={{alignSelf:'center', marginTop:25,backgroundColor:bgc,paddingHorizontal:30,paddingTop:7,borderRadius:150,borderWidth:2,borderRadius:120,borderColor:mcolor}} onPress={pickImage}>
            ...
            <View style={{marginTop:30,backgroundColor:mcolor,paddingTop:5,borderRadius:15,}}>
                ...
                <Image style={{alignSelf:'center',height:Wwidth,width:Wwidth,borderRadius:15,borderWidth:2,borderColor:bgc}} source={{uri:PostImg}} />
                <TextInput style={{height:40,width:'95%',color:bgc,fontFamily:'cour',fontSize:16,paddingLeft:20}} placeholder='add caption...' placeholderTextColor={bgc} onChangeText={(text) => setPostCap(text)} value={PostCaption} maxLength={100} />
            </View>
