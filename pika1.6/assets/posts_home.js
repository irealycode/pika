                        ...
                        <View key={index}>
                              <View style={{backgroundColor:'#00e8ff',paddingTop:5,borderRadius:15,}}>
                                  ...
                                  <TouchableWithoutFeedback onPress={() => DoubleTap(idx)} onLongPress={() => {setLongPressed(true);console.log('long press in');navigation.navigate('postImg',{postArray:index})}} onPressOut={() => {if (LongPress) {console.log('long press out');setLongPressed(false);navigation.navigate('home')}}}>
                                      <View>
                                        <Image style={{alignSelf:'center',height:Wwidth,width:Wwidth,borderRadius:15,borderWidth:2,borderColor:bgc}} source={{uri:'https://firebasestorage.googleapis.com/v0/b/pika-4f9d6.appspot.com/o/'+index[2]+'?alt=media&token=63a74aae-9e63-4382-a1fa-9179491c5f16'}} />
                                      </View>
                                  ...
                                  <TouchableOpacity style={{position:'absolute',right:10,bottom:-3,flex:1,flexDirection:'row'}}>
                                        <Image style={{opacity:count[idx],height:32,width:32,tintColor:bgc,position:'absolute',right:13,top:5}} source={require('./imgs/like.png')} />
                                        <Image style={{opacity:1,height:32,width:32,tintColor:bgc,position:'absolute',right:13,top:5}} source={require('./imgs/likeB.png')} />
                                        <Text style={{marginTop:7,color:bgc,fontFamily:'cour',fontSize:16}} >{likes[idx].length}</Text>
                                  </TouchableOpacity>                                  
                                  </View>
